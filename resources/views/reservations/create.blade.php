                    ...
                    <div class="divide-y divide-gray-200">
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            <div class="flex flex-col">
                                {!! Form::open(['route' => ['reservations.store'], 'autocomplete' => 'off']) !!}
                                {!! Form::label('client_name', 'Nombre del cliente', ['class' => 'leading-loose']) !!}
                                {!! Form::text('client_name', null, ['class' => 'px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600 capitalize', 'placeholder' => 'Nombre del cliente', 'required']) !!}
                                @error('client_name')
                        ...
                        <div class="pt-4 flex items-center space-x-4">
                            ...
                            {!! Form::submit('Crear reservación', ['class' => 'bg-blue-500 flex justify-center items-center w-full text-white px-4 py-3 rounded-md']) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
